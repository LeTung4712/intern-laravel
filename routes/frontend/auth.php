...
use App\Domains\Auth\Http\Controllers\Frontend\CalculatorController;
...
Route::group(['as' => 'auth.'], function () {
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::delete('calculator/history/clear', [CalculatorController::class, 'clearHistory'])->name('calculator.history.clear');
    });
